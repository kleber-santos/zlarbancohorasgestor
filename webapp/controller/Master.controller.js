...
sap.ui.define([
		...
		return BaseController.extend("whr.com.br.ZLARBancoHorasGestor.controller.Master", {
			...
			onOpenViewSettings : function (oEvent) {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("whr.com.br.ZLARBancoHorasGestor.view.ViewSettingsDialog", this);
